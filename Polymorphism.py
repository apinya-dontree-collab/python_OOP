#Polymarphism
#การพ้องรูป
#เกิดจาก poly หลากหลย morpholory รูปแบบ
...
account = Accounting("แป้ง", 35000, 27)
account._showData()
programmer = Programmer("เจเจ", 50000, 2, "พัฒนาเกม")
programmer._showData()
sale = Sale("ก้อย", 25000, "เชียงใหม่")
sale._showData()
